...
Feature: Grant type Guest Smb Auth k3
  ...
  Scenario: Grant type Guest Smb Auth Wrong authorization
    Then Send login by Grant type Request
      ...
      | guest_smb_auth | phone_number | 9809935444 | true  | k3           | k3  | Basic ajhiT29aMnkxRmh3RUtQY2FGU1NnWUhG3123YmZvYTprV3NrV2ZmNzVVUkJnSm9WeWlzalRjTWI4OUlh |
  ...
  Scenario: Grant type guest_smb_auth no phoneNumber parameter
    Then Send login by Grant type Request
      | grandType      | id_type      | id         | scope | finger_print | env | Authorization                                                                      |
      | guest_smb_auth | no           | 9809935444 | true  | k3           | k3  | Basic ajhiT29aMnkxRmh3RUtQY2FGU1NnWUhGYmZvYTprV3NrV2ZmNzVVUkJnSm9WeWlzalRjTWI4OUlh |
